...
const DISPLAY_TAG_DEFINITIONS: Record<string, string[]> = {
  ...
  Shoulders: ['Front Delts', 'Lateral Delts', 'Side Delts', 'Rear Delts'],
  ...
  Forearms: ['Forearms', 'Flexors', 'Extensors'],
  Quads: ['Quads'],
  Hamstrings: ['Hamstrings'],
  Glutes: ['Glutes'],
  Calves: ['Calves', 'Calves - Medial Head', 'Calves - Lateral Head', 'Soleus'],
  Adductors: ['Adductors'],
  Abductors: ['Abductors'],
