...
interface HyperResponsiveButtonProps {
...
const HyperResponsiveButtonInner: React.FC<HyperResponsiveButtonProps> = ({
  iconName,
  onPress,
  accessibilityLabel,
  disabled = false,
...
export const HyperResponsiveButton = memo(
  HyperResponsiveButtonInner,
  (prevProps, nextProps) => {
    return (
